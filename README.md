...
3. Заполнение тестовыми данными <br>
...
('popova', 'popova777', 'Попова Елена Владимировна', '8(915)678-90-12', 'popova@bk.ru', 'user'); <br> <br>
Добавление заявок <br>
...
(2, 'Основы веб-дизайна', '01.03.2024', 'transfer', 'Идет обучение', NULL), <br> <br>
(3, 'Основы проектирования баз данных', '10.02.2024', 'transfer', 'Обучение завершено', 'Очень полезный курс, рекомендую!'), <br>
(3, 'Основы алгоритмизации и программирования', '01.04.2024', 'cash', 'Новая', NULL), <br> <br>
(4, 'Основы веб-дизайна', '20.01.2024', 'cash', 'Обучение завершено', 'Хороший курс, но хотелось бы больше практики'), <br>
(4, 'Основы проектирования баз данных', '15.03.2024', 'transfer', 'Идет обучение', NULL), <br> <br>
